...
public class MJGATextDocumentService implements TextDocumentService, RequestService {
    @Override
    public CompletableFuture<String> refactorCode(JavaCodeParams javaCodeParams) {
        MJGALanguageServer.CLIENT.showMessage(new MessageParams(MessageType.Info, javaCodeParams.getCode()));
        MJGALanguageServer.CLIENT.showMessage(new MessageParams(MessageType.Info, "Refactoring to Functional..."));
        return CompletableFuture.supplyAsync(() -> "Diogo Costa");
    }
